...
ligand_blacklist = {
    ...
    'PG0': '2-(2-METHOXYETHOXY)ETHANOL', 'ETX': '2-ETHOXYETHANOL',
    'P4C': 'O-ACETALDEHYDYL-HEXAETHYLENE GLYCOL', '1PG': '2-(2-{2-[2-(2-METHOXY-ETHOXY)-ETHOXY]-ETHOXY}-ETHOXY)-ETHANOL',
    'DOD': 'DEUTERATED WATER', '1PE': 'PENTAETHYLENE GLYCOL',
    'BEZ': 'BENZOIC ACID', '2PE': 'NONAETHYLENE GLYCOL',
    'TME': 'PROPANE', 'P6G': 'HEXAETHYLENE GLYCOL',
    '3PO': 'TRIPHOSPHATE', '7PE': '2-(2-(2-(2-(2-(2-ETHOXYETHOXY)ETHOXY)ETHOXY)ETHOXY)ETHOXY)ETHANOL',
    'DTT': '2,3-DIHYDROXY-1,4-DITHIOBUTANE', 'NHE': '2-[N-CYCLOHEXYLAMINO]ETHANE SULFONIC ACID',
    'PGE': 'TRIETHYLENE GLYCOL', 'PGO': 'S-1,2-PROPANEDIOL',
    '8PE': '(2R)-3-{[(S)-(2-aminoethoxy)(hydroxy)phosphoryl]oxy}-2-(tetradecanoyloxy)propyl octadecanoate', '12P': 'DODECAETHYLENE GLYCOL',
    '13P': '1,3-DIHYDROXYACETONEPHOSPHATE', 'PGR': 'R-1,2-PROPANEDIOL',
    '9PE': '(1R)-2-{[(S)-(2-aminoethoxy)(hydroxy)phosphoryl]oxy}-1-[(heptanoyloxy)methyl]ethyl octadecanoate', 'P33': '3,6,9,12,15,18-HEXAOXAICOSANE-1,20-DIOL',
    '3PG': '3-PHOSPHOGLYCERIC ACID', 'TLA': 'L(+)-TARTARIC ACID',
    'MLA': 'MALONIC ACID', 'IMD': 'IMIDAZOLE',
    'FMT': 'FORMIC ACID', 'HEZ': 'HEXANE-1,6-DIOL',
    'ACN': 'ACETONE', 'PDO': '1,3-PROPANDIOL',
    'PG4': 'TETRAETHYLENE GLYCOL', 'PG5': '1-METHOXY-2-[2-(2-METHOXY-ETHOXY]-ETHANE',
    'NH3': 'AMMONIA', 'MRD': '(4R)-2-METHYLPENTANE-2,4-DIOL',
    '15P': 'POLYETHYLENE GLYCOL (N=34)', 'MPD': '(4S)-2-METHYL-2,4-PENTANEDIOL',
    'IPA': 'ISOPROPYL ALCOHOL', 'PE8': '3,6,9,12,15,18,21-HEPTAOXATRICOSANE-1,23-DIOL',
    'PE9': 'PENTAN-1-OL', 'HTO': 'HEPTANE-1,2,3-TRIOL',
    'PE5': '3,6,9,12,15,18,21,24-OCTAOXAHEXACOSAN-1-OL', 'PE6': 'PHOSPHORYL-HEXAETHYLENE GLYCOL',
    'PE7': '1-DEOXY-1-THIO-HEPTAETHYLENE GLYCOL', 'TBU': 'TERTIARY-BUTYL ALCOHOL',
    'PE1': 'N~2~-({3-HYDROXY-2-METHYL-5-[(PHOSPHONOOXY)METHYL]PYRIDIN-4-YL}METHYL)-L-LYSINE', 'PE2': '9-(4-HYDROXY-3-(HYDROXYMETHYL)BUT-1-YL)GUANINE',
    'PE3': '3,6,9,12,15,18,21,24,27,30,33,36,39-TRIDECAOXAHENTETRACONTANE-1,41-DIOL', 'CE1': 'O-DODECANYL OCTAETHYLENE GLYCOL',
    'PE4': '2-{2-[2-(2-{2-[2-(2-ETHOXY-ETHOXY)-ETHOXY]-ETHOXY}-ETHOXY)-ETHOXY]-ETHOXY}-ETHANOL', 'MOH': 'METHANOL',
    'PG6': '1-(2-METHOXY-ETHOXY)-2-{2-[2-(2-METHOXY-ETHOXY]-ETHOXY}-ETHANE', 'MES': '2-(N-MORPHOLINO)-ETHANESULFONIC ACID',
